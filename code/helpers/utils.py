...
def save_images(images, height, width, n_row, n_col,
  ...
  # imgPath = os.path.join(directory, filename_tmplte)
  # plt.imshow(images, cmap=plt.cm.binary)
  # fig1 = plt.gcf()
  # plt.show()
  # fig1.savefig(os.path.join(directory, filename_tmplte))
  i = 0
  ...
  fig1 = plt.gcf()
  plt.show()
  fig1.savefig(os.path.join(directory, filename))
#   return os.path.join(directory, filename_tmplte)
